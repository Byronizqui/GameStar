...
function dibujarTablaCatalogos(dataJson) {
    ...
    row.append($("<th><b>FECHA LANZAMIENTO</b></th>"));
    row.append($("<th><b>PLATAFORMA</b></th>"));
    row.append($("<th><b>CATEGORIA</b></th>"));
    row.append($("<th><b>CANTIDAD</b></th>"));
    row.append($("<th><b>NUM JUGADORES</b></th>"));
    row.append($("<th><b>PRECIO ALQUILER<b></th>"));
    row.append($("<th><b>PRECIO VENTA</b></th>"));
    row.append($("<th><b>INFORMACIÓN</b></th>"));
    row.append($("<th><b>DESARROLLADOR</b></th>"));
    row.append($("<th><b>DISTRIBUIDOR</b></th>"));
...
function dibujarFilaCatalogos(rowData) {
    ...
    row.append($("<td>" + rowData.CFechaLanzamiento + "</td>"));
    row.append($("<td>" + rowData.CPlataforma + "</td>"));
    row.append($("<td>" + rowData.categorias + "</td>"));
    row.append($("<td>" + rowData.CCantidad + "</td>"));
    row.append($("<td>" + rowData.CJugadores + "</td>"));
    row.append($("<td>" + rowData.CPrecAlqu+ "</td>"));
    row.append($("<td>" + rowData.CPrecComp+ "</td>"));
    row.append($("<td>" + rowData.CDescrip+ "</td>"));
    row.append($("<td>" + rowData.CDesarrollador+ "</td>"));
    row.append($("<td>" + rowData.CDistribuidor+ "</td>"));
   ...
   //Se envia la información por ajax
    $.ajax({
        ...
        success: function (rowData) { //si todo esta correcto en la respuesta del ajax, la respuesta queda en el data
            ...
            $("#nombreCatalogo").val(rowData.CNombre),
            $("#fechaLanzamiento").val(rowData.CFechaLanzamiento ),
            $("#cantidadE").val(rowData.CCantidad),
            $("#plataforma").val(rowData.CPlataforma),
            $("#precioAlquiler").val(rowData.CPrecAlqu),
            $("#precioVenta").val(rowData.CPrecComp),
            $("#urlImagen").val(),
            $("#descrip").val(rowData.CDescrip),
            $("#jugadores").val(rowData.CJugadores),
            $("#desarrollador").val(rowData.CDesarrollador),
            $("#distribuidor").val(rowData.CDistribuidor),
            $("#urlImagen").val(rowData.CUrlImg)
        },
        type: 'POST',
        dataType: "json"
    });
...
function validarCatalogo(){
    ...
    if ($("#nombreDirector").val() === "" || $("#plataforma").val().length > 45) {
        $("#groupDirector").addClass("has-error");
        validacion = false;
    }
    if ($("#actorPrincipal").val() === "" || $("#desarrollador").val().length > 45) {
