                        ...
                        '<form class="form-horizontal" method="post">'+
                            '<fieldset>'+
                                ...
                                '<div class="form-group">'+
                                    '<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon fa-2x"></i></span></br>'+
                                    '<div class="col-md-8">'+
                                ...
                                '<div class="form-group">'+
                                    '<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-envelope-o bigicon fa-2x"></i></span></br>'+
                                    '<div class="col-md-8">'+
                                        '<input id="email2" name="email2" type="text" placeholder="Correo Electrónico" class="form-control">'+
                                    '</div>'+
                                '</div>'+

                                '<div class="form-group">'+
                                    '<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-phone-square bigicon fa-2x"></i></span></br>'+
                                    '<div class="col-md-8">'+
                                ...
                                '<div class="form-group">'+
                                    '<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-pencil-square-o bigicon fa-2x"></i></span></br>'+
                                    '<div class="col-md-8">'+
                                        '<textarea class="form-control" id="message" name="message" placeholder="Deja tu mensaje aquí. Te responderemos lo más pronto posible." rows="7"></textarea>'+
                                    '</div>'+
                                '</div>'+
    ...
    (function () {
        ...
        (function () {
            ...
            $('#basicInfo').click(function () {
                Lobibox.notify('info', {
                    msg: 'El catálogo está listo para ser modificado'
                });
            });
        ...
        (function () {
            ...
            $('#basicSuccessPosition').click(function () {
                Lobibox.notify('success', {
                    position: 'top right',
                    msg: 'La información se ha agregado correctamente'
                });
            });
        })();
        //------------------------------------------------------------------------------
        ...
        (function () {
            ...
            $('#basicWarningAnimation').click(function () {
                Lobibox.notify('warning', {
                    showClass: 'bounceIn',
                    hideClass: 'bounceOut',
                    msg: 'La infomación está incompleta'
                });
            });
        ...
        (function () {
            ...
            $('#miniSuccessRounded').click(function () {
                Lobibox.notify('success', {
                    ...
                    rounded: true,
                    delayIndicator: false,
                    msg: 'Se ha agregado al carrito exitosamente!!'
                });
            });
        })();
    })();
