...
public class Usuarios  implements java.io.Serializable {
     ...
     private Set ordeneses = new HashSet(0);
    ...
    public Usuarios(int UId, String UUsuario, String UContrasena, String UNombre, String UApellidos, String UCorreo, Date UFechaNac, String UDireccion, String UTelCasa, String UTelCel, String UTipo, Set ordeneses) {
       this.UId = UId;
       this.UUsuario = UUsuario;
    ...
    public Set getOrdeneses() {
        return this.ordeneses;
    }
    
    public void setOrdeneses(Set ordeneses) {
        this.ordeneses = ordeneses;
    }
