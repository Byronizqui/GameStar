 ...
 */
package cr.ac.una.prograiv.gamestar.controller;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import cr.ac.una.prograiv.gamestar.bl.CatalogosBL;
import cr.ac.una.prograiv.gamestar.domain.Catalogos;
import cr.ac.una.prograiv.gamestar.domain.Categorias;
import cr.ac.una.prograiv.gamestar.domain.CatalogosAdapter;
        ...
        try {
            ...
            switch (accion) {
                ...
                case "agregarCatalogo": case "modificarCatalogo":   //Una pelicula o serie no deberia poder ser modificada
                    ...
                    Date date = sdf.parse(request.getParameter("fecha"));
                    Calendar cal = Calendar.getInstance();
                    cal.setTime(date);
                    c.setCNombre(request.getParameter("nombre"));
                    c.setCFechaLanzamiento(cal.getTime());
                    c.setCCantidad(Integer.parseInt(request.getParameter("cantidad")));
                    c.setCPlataforma(request.getParameter("plataforma"));
                    ...
                    c.setCJugadores(Integer.parseInt(request.getParameter("jugadores")));
                    c.setCDesarrollador(request.getParameter("desarrollador"));
                    c.setCDistribuidor(request.getParameter("distribuidor"));
