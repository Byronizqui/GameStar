...
import cr.ac.una.prograiv.gamestar.bl.DetallesBL;
import cr.ac.una.prograiv.gamestar.bl.OrdenesBL;
import cr.ac.una.prograiv.gamestar.bl.UsuariosBL;
import cr.ac.una.prograiv.gamestar.domain.Detalles;
import cr.ac.una.prograiv.gamestar.domain.Ordenes;
import cr.ac.una.prograiv.gamestar.domain.OrdenesAdapter;
import cr.ac.una.prograiv.gamestar.domain.Usuarios;
import cr.ac.una.prograiv.gamestar.domain.UsuariosAdapter;
                    ...
                    for (int i =0; i < f1.size(); i++){
                        if (f1.get(i).getOrdeneses().size() > 0){
                            for (int j =0; j < f1.get(i).getOrdeneses().size(); j++){
                                Ordenes aux = (Ordenes)f1.get(i).getOrdeneses().iterator().next();
                                Ordenes o = oBL.findById(aux.getOId());
